-- Rizky Jaya App - upgrade database existing: kode karyawan otomatis dan workflow approval.
-- Jalankan setelah 202605310006_realtime_attendance_profile_update.sql.
